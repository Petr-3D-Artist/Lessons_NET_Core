...
namespace Lessons_NER_Core
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] myArray2 = myArray[1..4]; // Будет извлекать элементы с 1 по 4, можно написать и [..4]
            ...
            */
            ...
            Console.WriteLine(myArray[myIndex]); // Сразу покажет элемент последний из массива, с конца
            Console.WriteLine();
